...
static const uint32_t FT_SCRIPTING_SERIALIZED_HEADER_BYTES = 24U;
...
enum scripting_opcode : uint8_t
{
    ...
    SCRIPTING_OP_EQUAL = 14U,
    SCRIPTING_OP_NOT_EQUAL = 15U,
    SCRIPTING_OP_LESS_THAN = 16U,
    SCRIPTING_OP_LESS_EQUAL = 17U,
    SCRIPTING_OP_GREATER_THAN = 18U,
    SCRIPTING_OP_GREATER_EQUAL = 19U,
    SCRIPTING_OP_JUMP_IF_FALSE = 20U,
