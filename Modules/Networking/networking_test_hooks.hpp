...
enum networking_test_failure_point : uint8_t
{
    ...
    NETWORKING_TEST_SECURE_DERIVE_SEND = 19U,
    NETWORKING_TEST_SECURE_DERIVE_RECEIVE = 20U,
    NETWORKING_TEST_SECURE_INIT_SEND = 21U,
    NETWORKING_TEST_SECURE_INIT_RECEIVE = 22U,
    NETWORKING_TEST_SECURE_INIT_PREVIOUS = 23U,
    NETWORKING_TEST_SECURE_BACKEND_SWAP = 24U,
    NETWORKING_TEST_SECURE_SWAP_SEND = 25U,
    NETWORKING_TEST_SECURE_SWAP_RECEIVE = 26U,
    NETWORKING_TEST_SECURE_SWAP_PREVIOUS = 27U,
    NETWORKING_TEST_SECURE_MOVE_INIT_SEND = 28U,
    NETWORKING_TEST_SECURE_MOVE_INIT_RECEIVE = 29U,
    NETWORKING_TEST_SECURE_MOVE_INIT_PREVIOUS = 30U,
    NETWORKING_TEST_SECURE_MOVE_SWAP_SEND = 31U,
    NETWORKING_TEST_SECURE_MOVE_SWAP_RECEIVE = 32U,
    NETWORKING_TEST_SECURE_MOVE_SWAP_PREVIOUS = 33U,
    NETWORKING_TEST_FAILURE_POINT_COUNT = 34U
};
