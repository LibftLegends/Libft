...
$(LIBFT_GLOBAL_RELEASE_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.cpp $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_RELEASE_ROOT)/Modules/$(1)
	$$(CXX) $$(LIBFT_GLOBAL_CPP_COMPILE_FLAGS) $$(LIBFT_GLOBAL_$(1)_CPP_FLAGS) -MMD -MP -MF $$(@:.o=.d) -MT $$@ -c $$< -o $$@

$(LIBFT_GLOBAL_DEBUG_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.cpp $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_DEBUG_ROOT)/Modules/$(1)
	$$(CXX) $$(LIBFT_GLOBAL_DEBUG_COMPILE_FLAGS) $$(LIBFT_GLOBAL_$(1)_CPP_FLAGS) -MMD -MP -MF $$(@:.o=.d) -MT $$@ -c $$< -o $$@

$(LIBFT_GLOBAL_TEST_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.cpp $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_TEST_ROOT)/Modules/$(1)
	$$(CXX) $$(LIBFT_GLOBAL_TEST_COMPILE_FLAGS) $$(LIBFT_GLOBAL_$(1)_CPP_FLAGS) -MMD -MP -MF $$(@:.o=.d) -MT $$@ -c $$< -o $$@

$(LIBFT_GLOBAL_TEST_DEBUG_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.cpp $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_TEST_DEBUG_ROOT)/Modules/$(1)
...
$(LIBFT_GLOBAL_RELEASE_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.c $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_RELEASE_ROOT)/Modules/$(1)
	$$(LIBFT_GLOBAL_CC) $$(LIBFT_GLOBAL_$(1)_C_FLAGS) -MMD -MP -MF $$(@:.o=.d) -MT $$@ -c $$< -o $$@

$(LIBFT_GLOBAL_DEBUG_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.c $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_DEBUG_ROOT)/Modules/$(1)
	$$(LIBFT_GLOBAL_CC) $$(LIBFT_GLOBAL_$(1)_C_FLAGS) -DDEBUG=1 -MMD -MP -MF $$(@:.o=.d) -MT $$@ -c $$< -o $$@

$(LIBFT_GLOBAL_TEST_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.c $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_TEST_ROOT)/Modules/$(1)
	$$(LIBFT_GLOBAL_CC) $$(LIBFT_GLOBAL_$(1)_C_FLAGS) -DLIBFT_TEST_BUILD -MMD -MP -MF $$(@:.o=.d) -MT $$@ -c $$< -o $$@

$(LIBFT_GLOBAL_TEST_DEBUG_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.c $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_TEST_DEBUG_ROOT)/Modules/$(1)
...
$(LIBFT_GLOBAL_RELEASE_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.mm $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_RELEASE_ROOT)/Modules/$(1)
	$$(CXX) $$(LIBFT_GLOBAL_CPP_COMPILE_FLAGS) $$(LIBFT_GLOBAL_$(1)_CPP_FLAGS) $$(LIBFT_GLOBAL_$(1)_MM_FLAGS) -MMD -MP -MF $$(@:.o=.d) -MT $$@ -c $$< -o $$@

$(LIBFT_GLOBAL_DEBUG_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.mm $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_DEBUG_ROOT)/Modules/$(1)
	$$(CXX) $$(LIBFT_GLOBAL_DEBUG_COMPILE_FLAGS) $$(LIBFT_GLOBAL_$(1)_CPP_FLAGS) $$(LIBFT_GLOBAL_$(1)_MM_FLAGS) -MMD -MP -MF $$(@:.o=.d) -MT $$@ -c $$< -o $$@

$(LIBFT_GLOBAL_TEST_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.mm $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_TEST_ROOT)/Modules/$(1)
	$$(CXX) $$(LIBFT_GLOBAL_TEST_COMPILE_FLAGS) $$(LIBFT_GLOBAL_$(1)_CPP_FLAGS) $$(LIBFT_GLOBAL_$(1)_MM_FLAGS) -MMD -MP -MF $$(@:.o=.d) -MT $$@ -c $$< -o $$@

$(LIBFT_GLOBAL_TEST_DEBUG_ROOT)/Modules/$(1)/%.o: $(LIBFT_GLOBAL_GRAPH_PREFIX)Modules/$(1)/%.mm $(LIBFT_GLOBAL_GRAPH_PREFIX)mk/modules/$(1).mk | $(LIBFT_GLOBAL_TEST_DEBUG_ROOT)/Modules/$(1)
...
LIBFT_GLOBAL_DIRECTORIES := $(sort $(patsubst %/,%,$(dir $(LIBFT_GLOBAL_RELEASE_OBJECTS) $(LIBFT_GLOBAL_DEBUG_OBJECTS) $(LIBFT_GLOBAL_TEST_OBJECTS) $(LIBFT_GLOBAL_TEST_DEBUG_OBJECTS))))
