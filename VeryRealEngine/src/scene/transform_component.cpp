...
TransformComponent::TransformComponent(const TransformComponent &other) : _position(other._position),
	_rotation(other._rotation), _scale(other._scale), _spin(other._spin),
