...
VisibilityComponent::VisibilityComponent(const VisibilityComponent &other) : _visible(other._visible)
{
}

VisibilityComponent &VisibilityComponent::operator=(const VisibilityComponent &other)
{
	if (this != &other)
