...
PhysicsBodyComponent::PhysicsBodyComponent(const PhysicsBodyComponent &other) : _body(other._body)
{
}

PhysicsBodyComponent &PhysicsBodyComponent::operator=(const PhysicsBodyComponent &other)
{
	if (this != &other)
		_body = other._body;
	return (*this);
