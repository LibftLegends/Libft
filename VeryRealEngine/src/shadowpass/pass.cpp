...
void ShadowPass::create(const VulkanDevice &device)
{
	...
	ShadowPipelineFactory::create(_device, _render_pass, kShadowMapResolution,
		sizeof(ShadowPushConstants), &_pipeline_layout, &_pipeline);
}
...
{
	return (ShadowLightMatrix::compute(shadow_caster));
}
