...
#include "../renderer/shadowlightmatrix.hpp"
...
class ShadowPass
{
  public:
	...
	/// Computes a shadow caster's light-space (view*projection) matrix
	/// (see ShadowLightMatrix for the directional-vs-point and
	/// scene-bounds caveats).
	 ...
	 * @param light_space_matrix This caster's light-space
