...
SwapchainSupportDetails::SwapchainSupportDetails(const SwapchainSupportDetails &other) : _capabilities(other._capabilities),
	_formats(other._formats), _present_modes(other._present_modes)
{
}

SwapchainSupportDetails &SwapchainSupportDetails::operator=(const SwapchainSupportDetails &other)
{
	if (this != &other)
	{
...
const std::vector<VkSurfaceFormatKHR> &SwapchainSupportDetails::formats() const
{
	return (_formats);
}

const std::vector<VkPresentModeKHR> &SwapchainSupportDetails::present_modes() const
{
