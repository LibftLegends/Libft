...
class PostProcessPass
{
  public:
	...
	/// outputs and writes the composited result to swapchain image `image_index`.
  ...
  private:
	...
	void create_render_pass(VkDevice device, VkFormat swapchain_image_format);
	void create_samplers(VkDevice device);
	...
	/**
		...
		* treatment as GeometryPass::GlobalUbo, not a fully encapsulated class.
		*/
