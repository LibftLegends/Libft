...
namespace vre
{
GeometryPipelineFactory::GeometryPipelineFactory()
{
}

GeometryPipelineFactory::GeometryPipelineFactory(
	const GeometryPipelineFactory &)
{
}

GeometryPipelineFactory &GeometryPipelineFactory::operator=(
	const GeometryPipelineFactory &)
{
	return (*this);
}
...
void GeometryPipelineFactory::create(VkDevice device,
	VkRenderPass render_pass, VkDescriptorSetLayout material_set_layout,
...
{
	VkShaderModule vertex_module = VulkanDevice::load_shader_module(device,
			"shaders/mesh.vert.spv");
	VkShaderModule fragment_module = VulkanDevice::load_shader_module(device,
	...
	// frontFace is CLOCKWISE — see ShadowPipelineFactory's rasterizer
	// state for why: mat4::perspective's Y-flip mirrors screen-space
	...
	VkDescriptorSetLayout set_layouts[] = {material_set_layout,
		global_set_layout};
