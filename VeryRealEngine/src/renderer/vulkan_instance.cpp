...
VkBool32 VulkanInstance::debug_callback(VkDebugUtilsMessageSeverityFlagBitsEXT severity,
...
void VulkanInstance::setup_debug_messenger()
{
	...
	create_fn = reinterpret_cast<PFN_vkCreateDebugUtilsMessengerEXT>(vkGetInstanceProcAddr(_instance,
...
void VulkanInstance::destroy()
{
	...
	{
		destroy_fn = reinterpret_cast<PFN_vkDestroyDebugUtilsMessengerEXT>(vkGetInstanceProcAddr(_instance,
