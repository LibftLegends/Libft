...
ContactResolver::ContactResolver(const ContactResolver &)
{
}

ContactResolver &ContactResolver::operator=(const ContactResolver &)
{
	return (*this);
}
...
void ContactResolver::resolve(PhysicsBody *a, PhysicsBody *b,
