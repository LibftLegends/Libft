...
ParticleSystemDesc::ParticleSystemDesc(const ParticleSystemDesc &other) : _emitter_position(other._emitter_position),
	_mesh(other._mesh), _spawn_interval(other._spawn_interval),
	_lifetime(other._lifetime), _start_scale(other._start_scale),
	_base_velocity(other._base_velocity),
	_velocity_jitter(other._velocity_jitter), _random_seed(other._random_seed)
{
}

ParticleSystemDesc &ParticleSystemDesc::operator=(const ParticleSystemDesc &other)
{
	if (this != &other)
	{
