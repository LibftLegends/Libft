...
ParticleSystem::Particle::Particle(const Particle &other) : position(other.position),
	velocity(other.velocity), age(other.age)
{
}

ParticleSystem::Particle &ParticleSystem::Particle::operator=(const Particle &other)
{
	if (this != &other)
	{
...
ParticleSystem::ParticleSystem(const ParticleSystem &other) : _desc(other._desc),
	_particles(other._particles), _spawn_accumulator(other._spawn_accumulator),
