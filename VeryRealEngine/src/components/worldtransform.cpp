...
WorldTransformComponent::WorldTransformComponent(
	const WorldTransformComponent &other) : _value(other._value)
{
}

WorldTransformComponent &WorldTransformComponent::operator=(
	const WorldTransformComponent &other)
{
	if (this != &other)
		_value = other._value;
	return (*this);
...
WorldTransformComponent::WorldTransformComponent(const mat4 &value) :
	_value(value)
{
}
